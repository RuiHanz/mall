...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">品牌搜索</li>
        </ol>

        <!-- Example DataTables Card-->
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-table"></i> 品牌管理 </div>
            <form action="/selectMark.do" method="post" style="margin: 30px 30px ">
                <div class="row">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0" align="center">
                        ...
                        <tr >
                            ...
                            <th align="center" style="text-align: center" colspan="2">操作</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="mark" items="${pageBean.list}" varStatus="vs">
<%--                        <c:forEach items="${markList}" var="mark">--%>
                        <tr >
                            <td align="center">${mark.ppmch}</td>
                            <td align="center" ><a  href="javascript:if(confirm('确定修改吗?'))location='/updateMark.do?pp_id=${mark.pp_id}&currentPage=${requestScope.pageBean.currentPage}&handle=update';">修改</a></td>
                            <td align="center" ><a  href="javascript:if(confirm('确定删除吗?'))location='/updateMark.do?pp_id=${mark.pp_id}&currentPage=${requestScope.pageBean.currentPage}&handle=delete';">删除</a></td>
                        </tr>
                        </c:forEach>
                        ...
                        <tr>
                            ...
                             <a href="${pageContext.request.contextPath }/selectMark.do?selectType=0&currentPage=1">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="${pageContext.request.contextPath }/selectMark.do?selectType=0&currentPage=${requestScope.pageBean.currentPage - 1}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="${pageContext.request.contextPath }/selectMark.do?selectType=0&currentPage=${requestScope.pageBean.currentPage + 1}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             <a href="${pageContext.request.contextPath }/selectMark.do?selectType=0&currentPage=${requestScope.pageBean.totalPage}">末页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
